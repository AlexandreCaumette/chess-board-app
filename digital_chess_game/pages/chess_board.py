from digital_chess_game.pages.image_extractor import ImageExtractor
from digital_chess_game.pages.piece_classifier import PieceClassifier
import os
import chess
import chess.engine
import chess.svg
...
class ChessBoard:
    ...
    def export_board_as_png(self):
        ...
        # Convert SVG to PNG
        png_filename = os.path.join("assets", "digital_chessboards", "chessboard.png")
